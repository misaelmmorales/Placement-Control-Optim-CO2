...
class ConvLSTMCell(nn.Module):
    ...
    def forward(self, input_tensor, cur_state):
        ...
        h_cur, c_cur = h_cur.to(device), c_cur.to(device)
    ...
    def init_hidden(self, batch_size, image_size):
        ...
        return (torch.zeros(batch_size, self.hidden_dim, height, width, device=self.c.weight.device),
                torch.zeros(batch_size, self.hidden_dim, height, width, device=self.c.weight.device))
