...
MeasureType = 6                                # Measurement type: 1 for pressure; 2 for CO2 saturation; 3 for tempeture, 4 for pressure+CO2 saturation                     
nColumn_data = [39,39]                           # The column in which the data measurement is located 
