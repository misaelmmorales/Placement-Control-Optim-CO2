...
MeasureType = 7                                # Measurement type: 1 for pressure; 2 for CO2 saturation; 3 for tempeture, 4 for pressure+CO2 saturation                     
nColumn_data = [39,39,39]                           # The column in which the data measurement is located 
...
if MeasureType == 1:    # for pressure
    ...
    eps =  0.05 
elif MeasureType == 3:  # for temperature
    data_filename = 'run_temp.his' 
    eps = 0.002 
elif MeasureType == 4:  # for pressure+CO2 saturation
    data_filename = ['run_presWAT.his','run_co2sl.his']
    eps = [0.002, 0.05]
elif MeasureType == 5:  # for pressure+temperature
    data_filename = ['run_presWAT.his','run_temp.his']
    eps = [0.002, 0.002]
elif MeasureType == 6:  # for CO2 saturation+temperature
    data_filename = ['run_co2sl.his','run_temp.his']
    eps = [0.05, 0.002]
elif MeasureType == 7:  # for pressure+CO2 saturation+temperature
    data_filename = ['run_presWAT.his','run_co2sl.his','run_temp.his']
    eps = [0.002, 0.05, 0.002]
else:
