...
% The simulation will consist of two periods:
% (1) Constant injection period of 10 years, with time step of 0.5 year.
% CO2 is injected as constant rate from the single injector. 
% (2) Post-injection period of 500 years using time steps of 10 years.
