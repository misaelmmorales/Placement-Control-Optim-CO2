...
inj_timestep = rampupTimesteps(inj_time, year/12, 0);
inj_cumtime  = convertTo(cumsum(inj_timestep), year);

mon_timestep = rampupTimesteps(mon_time, year, 0);
mon_cumtime  = convertTo(cumsum(mon_timestep), year);

total_timestep = [inj_timestep; mon_timestep]; 
total_cumtime  = [inj_cumtime;  mon_cumtime];
