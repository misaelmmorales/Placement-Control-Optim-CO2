...
figure; plotCellData(extractSubgrid(G, j==48 & i>18 & i < 60), states{1}.s(j==48 & i>18 & i < 60,2)); 
view(0,0); axis tight;

figure; plotCellData(extractSubgrid(G, j==48 & i>18 & i < 60), states{end}.s(j==48 & i>18 & i < 60,2)); 
view(0,0); axis tight;
